...
$content = 
	$pageModel->createViewType1($_POST['cms_model'], $_POST['cms_table'], $_POST['cms_table'], $ownColumns, $metaTags, $imagesAndThumbsCounter, $gallery);

//$content = preg_replace('#/\*\*(.*?)\*\*/#s', '', $content);

file_put_contents( $_SERVER['DOCUMENT_ROOT'].'/app/view/templates/' . $_POST['cms_model'] . '.phtml', $content);
$model->deleteEnters($_SERVER['DOCUMENT_ROOT'].'/app/view/templates/' . $_POST['cms_model'] . '.phtml');

$content = $pageModel->deleteCommentsHTML($_SERVER['DOCUMENT_ROOT'].'/app/view/templates/' . $_POST['cms_model'] . '.phtml');
